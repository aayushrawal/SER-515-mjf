							...
							<Row className="row-grid">
								<Col lg="4">
									<Card className="card-lift--hover shadow border-0">
										<CardImg className="img-fluid" src={visa} alt="placeholder" width="100%" />
								...
								<Col lg="4">
									<Card className="card-lift--hover shadow border-0">
										<CardImg className="img-fluid" src={wanda} alt="placeholder" width="100%" />
										<CardBody className="py-5">
					...
					<Row className="justify-content-center">
						<Col lg="12">
							<Row className="row-grid">
								...
								<Col lg="4">
									<Card className="card-lift--hover shadow border-0">
										<CardImg className="img-fluid" src={kia} alt="placeholder" width="100%" />
										<CardBody className="py-5">
											<h6 className="text-primary text-uppercase">Hyundai Kia</h6>
								...
								<Col lg="4">
									<Card className="card-lift--hover shadow border-0">
										<CardImg className="img-fluid" src={cola} alt="placeholder" width="100%" />
										<CardBody className="py-5">
