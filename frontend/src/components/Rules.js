			...
			<div class="Rules-Body">
				<div class="ArticleStory">
					<p>
						...
						the other four coming from England, Scotland, Northern Ireland, and Wales – all countries that
						contributed to the development of the sport. FIFA’s most recently published rule book is 140
						pages long, which is a bit ambitious for the casual player who is just becoming familiarized
						with the game. For this reason, we have prepared a simplified version below that should allow
						you to learn the basic rules of soccer. It is also important to note that although FIFA
						publishes an established set of rules, they are often modified by national and regional leagues
						and organizations. With that, you should ensure that you inquire with your coach, fellow players
					...
					<p>
						...
						The field must be rectangular in shape, and distinctly marked by two short goal lines and two
						long-touch lines. The field is divided into halves, separated by the halfway line, which runs
						from the midpoints of each touchline. At the midpoint of the halfway line is a marked center
						point surrounded by a lined center circle with a radius of 10 yards. Opposing players are not
						allowed to enter this circle during the possessing team’s kick-off. The length of the touch line
					...
					<ul>
						...
						<li>At each end of the field is an eight-yard-wide goal centered along the goal line.</li>
						<li>
					...
					<p>
						...
						circumference must be in the range of 27 to 28 inches. This rule is only applicable for official
						sanctioned matches, as youth leagues often employ the use of a smaller ball that is better
						suited to children.
					</p>
					<div>
						<b>
					...
					<p>
						...
						11-player total. If a team cannot field at least seven players at match time, the game is a
						forfeit. Teams of fewer than 11 a side can often be seen in youth leagues where smaller teams
						are used as a developmental tool. FIFA-sanctioned matches are generally limited to three
						...
						the halfway line, upon the referee’s approval, and after the player being subbed out has left
						the pitch. The goalkeeper may be substituted with anyone on the pitch or any eligible substitute
					...
					<p>
						...
						duties – this includes signaling with a flag when a ball goes of play, when a player is fouled,
					...
					<p>
						...
						The extra time generally corresponds with the referee’s determination of how much time was taken
						up due to substitutions and injuries. The amount of extra time is announced and displayed at the
						half line at the end of each 45-minute period. Although soccer does have an allotted time limit,
						it is ultimately up to the referee’s as to when to end a match.
					</p>
					<div>
						<b>
					...
					<p>
						...
						half, and after each goal scored, and is taken at the center of the halfway line. If a team
					...
					<p>
						...
						the referee raising his hand during the kick. An indirect kick can only go into the goal if it
						has subsequently been touched by another player before it enters the goal. The ball must be
					...
					<p>
						...
						throw-in is given to the opposing team. Players are not allowed to score directly off a
						throw-in.
					</p>
					<div>
						<b>
