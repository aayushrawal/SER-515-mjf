...
import "./VolunteerDirectorLogin.scss";
...
const VolunteerDirectorLogin = (props) => {
      ...
      .then((res) => {
        if (res.status === 200) {
          ...
          if (response.status === "ok") {
            history.push("/volunteer-director/home");
          } else {
            resetForm();
            const createObj = {
              alertColor: "danger",
                ...
                <Card className="bg-secondary shadow border-0">
                  <CardBody className="px-lg-5 py-lg-5">
                    <div className="text-center mb-4">
                      <small>Volunteer Director Login</small>
                    </div>
...
export default VolunteerDirectorLogin;
