...
import { Button, Card, CardBody, FormGroup, Input, InputGroupAddon, InputGroupText,
          InputGroup, Container, Row, Col } from "reactstrap";
              ...
              <Row className="text-center justify-content-center">
                <Col lg="10">
                  ...
                  <p className="lead text-white">
                    Answers to all question so that particpants will know about the event!!
                  </p>
                </Col>
              </Row>
                          </Container>    
